...
在「设置 → 高级 → 标题设置」中新增 5 种窗口标题显示模式，所有模式均附加 `-Mineradio` 后缀：

| 模式 | 格式 | 示例 |
| --- | --- | --- |
| 歌曲名 | `歌曲名 -Mineradio` | `晴天 -Mineradio` |
| 歌曲名-歌手 | `歌曲名-歌手 -Mineradio` | `晴天-周杰伦 -Mineradio` |
| 整句歌词 | `当前歌词行 -Mineradio` | `故事的小黄花 -Mineradio` |
| 逐词歌词 | `当前高亮部分 -Mineradio` | `故事的小 -Mineradio` |
| 软件名 | `Mineradio` | `Mineradio` |
